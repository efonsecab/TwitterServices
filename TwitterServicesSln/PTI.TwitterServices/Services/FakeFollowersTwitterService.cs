...
namespace PTI.TwitterServices.Services
{
    ...
    public class FakeFollowersTwitterService
    {
        ...
        public async Task<List<PossibleFakeUser>> GetAllPossibleFakeFollowersForUsernameAsync(string username,
            Action<PossibleFakeUser> onNewPossibleFakeFollowedDetectedAction = null)
        {
        ...
        {
            this.Logger?.LogInformation($"Looking for possible fake reasons for: {singleFollower.ScreenNameResponse}");
            List<PossibleFakeReason> lstPossibleFakeReasons = new List<PossibleFakeReason>();
            if (singleFollower.Protected) //we will ignore protected accounts
